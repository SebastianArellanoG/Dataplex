...
exports.DataScanServiceClient = void 0;
 ...
 */
const gapicConfig = require("./data_scan_service_client_config.json");
...
class DataScanServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listDataScans: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'dataScans'),
            listDataScanJobs: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'dataScanJobs'),
        };
        ...
        const createDataScanResponse = protoFilesRoot.lookup('.google.cloud.dataplex.v1.DataScan');
        const createDataScanMetadata = protoFilesRoot.lookup('.google.cloud.dataplex.v1.OperationMetadata');
        const updateDataScanResponse = protoFilesRoot.lookup('.google.cloud.dataplex.v1.DataScan');
        const updateDataScanMetadata = protoFilesRoot.lookup('.google.cloud.dataplex.v1.OperationMetadata');
        const deleteDataScanResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteDataScanMetadata = protoFilesRoot.lookup('.google.cloud.dataplex.v1.OperationMetadata');
        this.descriptors.longrunning = {
            createDataScan: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createDataScanResponse.decode.bind(createDataScanResponse), createDataScanMetadata.decode.bind(createDataScanMetadata)),
            updateDataScan: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateDataScanResponse.decode.bind(updateDataScanResponse), updateDataScanMetadata.decode.bind(updateDataScanMetadata)),
            deleteDataScan: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteDataScanResponse.decode.bind(deleteDataScanResponse), deleteDataScanMetadata.decode.bind(deleteDataScanMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dataplex.v1.DataScanService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.dataScanServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dataplex.v1.DataScanService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dataplex.v1.DataScanService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of dataScanServiceStubMethods) {
            const callPromise = this.dataScanServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getDataScan(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    runDataScan(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    getDataScanJob(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    generateDataQualityRules(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.generateDataQualityRules(request, options, callback);
    }
    createDataScan(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkCreateDataScanProgress(name) {
    ...
    updateDataScan(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'data_scan.name': (_a = request.dataScan.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
     ...
     */
    async checkUpdateDataScanProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    deleteDataScan(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkDeleteDataScanProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    listDataScans(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listDataScansStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listDataScans.createStream(this.innerApiCalls.listDataScans, request, callSettings);
    }
    /**
    ...
    listDataScansAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listDataScans.asyncIterate(this.innerApiCalls['listDataScans'], request, callSettings);
    }
    listDataScanJobs(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listDataScanJobsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listDataScanJobs.createStream(this.innerApiCalls.listDataScanJobs, request, callSettings);
    }
    /**
    ...
    listDataScanJobsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listDataScanJobs.asyncIterate(this.innerApiCalls['listDataScanJobs'], request, callSettings);
    }
    /**
...
exports.DataScanServiceClient = DataScanServiceClient;
//# sourceMappingURL=data_scan_service_client.js.map