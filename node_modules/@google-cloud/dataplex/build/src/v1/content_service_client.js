...
exports.ContentServiceClient = void 0;
 ...
 */
const gapicConfig = require("./content_service_client_config.json");
...
class ContentServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listContent: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'content'),
        };
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dataplex.v1.ContentService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.contentServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dataplex.v1.ContentService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dataplex.v1.ContentService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of contentServiceStubMethods) {
            const callPromise = this.contentServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    createContent(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    updateContent(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'content.name': (_a = request.content.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateContent(request, options, callback);
    }
    deleteContent(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    getContent(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listContent(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listContentStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listContent.createStream(this.innerApiCalls.listContent, request, callSettings);
    }
    /**
    ...
    listContentAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listContent.asyncIterate(this.innerApiCalls['listContent'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=content_service_client.js.map