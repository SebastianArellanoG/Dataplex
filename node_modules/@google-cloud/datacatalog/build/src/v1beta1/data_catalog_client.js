...
exports.DataCatalogClient = void 0;
...
class DataCatalogClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            ...
            tagTemplateFieldEnumValuePathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/tagTemplates/{tag_template}/fields/{tag_template_field_id}/enumValues/{enum_value_display_name}'),
        ...
        this.descriptors.page = {
            searchCatalog: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'results'),
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.datacatalog.v1beta1.DataCatalog', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.dataCatalogStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.datacatalog.v1beta1.DataCatalog')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.datacatalog.v1beta1.DataCatalog, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of dataCatalogStubMethods) {
            const callPromise = this.dataCatalogStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    updateTagTemplate(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'tag_template.name': (_a = request.tagTemplate.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
    ...
    renameTagTemplateFieldEnumValue(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    updateTag(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'tag.name': (_a = request.tag.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
    ...
    searchCatalogStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.searchCatalog.createStream(this.innerApiCalls.searchCatalog, request, callSettings);
    }
    /**
    ...
    searchCatalogAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.searchCatalog.asyncIterate(this.innerApiCalls['searchCatalog'], request, callSettings);
    }
