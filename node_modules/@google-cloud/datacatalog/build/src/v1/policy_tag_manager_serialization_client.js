...
exports.PolicyTagManagerSerializationClient = void 0;
...
class PolicyTagManagerSerializationClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.datacatalog.v1.PolicyTagManagerSerialization', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.policyTagManagerSerializationStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.datacatalog.v1.PolicyTagManagerSerialization')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.datacatalog.v1
                    .PolicyTagManagerSerialization, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of policyTagManagerSerializationStubMethods) {
            const callPromise = this.policyTagManagerSerializationStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    replaceTaxonomy(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    importTaxonomies(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    exportTaxonomies(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
...
exports.PolicyTagManagerSerializationClient = PolicyTagManagerSerializationClient;
//# sourceMappingURL=policy_tag_manager_serialization_client.js.map